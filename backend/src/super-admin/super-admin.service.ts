  ...
  async getSystemDashboard() {
    return {
      ...
      recentUsers: [
        ...
        { id: 2, email: 'manager@bank.co.ke', firstName: 'Manager', lastName: 'User', role: 'MANAGER' }
      ]
    };
  }
  ...
  async getAllOrganizations() {
    return [
      { 
        ...
        subdomain: 'default',
        isActive: true,
        _count: { users: 5, requirements: 57, gapAssessments: 3, actionPlans: 2, risks: 1, schedules: 4 }
      },
      { 
        id: 2, 
        ...
        subdomain: 'equity',
        isActive: true,
        _count: { users: 4, requirements: 57, gapAssessments: 3, actionPlans: 2, risks: 1, schedules: 4 }
      },
      { 
        id: 3, 
        name: 'KCB Bank Kenya', 
